...
<div class="ds-stack">
	...
	<div class="ds-notice ds-notice--info"><?php echo designstack_icon( 'info' ); ?><div class="ds-notice__body"><p class="ds-notice__text">С этого подключения за час уже пришло три предложения. Попробуй ещё раз через час — так мы защищаемся от спама.</p></div></div>
